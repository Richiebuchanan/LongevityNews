...
1. **Commit these six HTML files to the root of `Richiebuchanan/LongevityNews`** (main branch). Enable GitHub Pages: Settings → Pages → Deploy from branch → main / root. Site will be at `https://richiebuchanan.github.io/LongevityNews/`.
